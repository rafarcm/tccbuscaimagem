# Sistema de Busca de Imagens por Similaridade para Web

Projeto desenvolvido para conclusão do curso de Graduação pela Universidade de São Paulo - USP, no curso de Sistemas de Informação.
